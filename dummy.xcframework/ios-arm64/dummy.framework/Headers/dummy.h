...
@interface DummyBase (DummyBaseCopying) <NSCopying>
@end;
...
@interface NSError (NSErrorDummyKotlinException)
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DummyDelegate")))
@interface DummyDummyDelegate : DummyBase
